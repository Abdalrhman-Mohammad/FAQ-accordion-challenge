...
function openorclose(name) {
  ...
  if (vars[ButtonNumber]) {
    document.getElementById(name.id).style.backgroundImage = "url('assets/images/icon-minus.svg')";
    document.getElementById("p" + ButtonNumber).style.visibility = 'visible';
    document.getElementById("p" + ButtonNumber).style.height ="auto";
  } else {
    document.getElementById(name.id).style.backgroundImage = "url('assets/images/icon-plus.svg')";
